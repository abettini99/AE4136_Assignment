...
class Grid2D:
    ...
    matPcell_idx:        npt.NDArray[np.int32]       = field(init=False, repr=False)   ## [N+2, M+2]      // cell numbering, real, boundary, and spurious cells
    matPface_idx:        list[npt.NDArray[np.int32]] = field(init=False, repr=False)   ## [2 -> [x,x]]    // face numbering, real, boundary, and spurious faces
    matPvert_idx:        npt.NDArray[np.int32]       = field(init=False, repr=False)   ## [N+1, M+1]      // vertices numbering, real vertices
    matPcellface_idx:    npt.NDArray[np.int32]       = field(init=False, repr=False)   ## [4, N+2, M+2]   // cell-face connectivity, real, boundary, and spurious faces
    ...
    bPcells_idx:         list[npt.NDArray[np.int32]] = field(init=False, repr=False)   ## [4 -> [x]]      // boundary cell indicess
    bPface_idx:          list[npt.NDArray[np.int32]] = field(init=False, repr=False)   ## [4 -> [x]]      // boundary cell indicess
    ...
    def __post_init__(self) -> None:
        ...
        #### ======================= ####
        ## Generate boundary primal cell data, simple slicing
        ...
        ## Generate boundary face data, simple slicing
